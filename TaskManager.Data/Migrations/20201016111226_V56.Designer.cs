...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManager.Data.AuditType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TaskManager.Data.TaskAudit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TaskManager.Data.TaskFollowUpStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TaskManager.Data.Employee", b =>
                {
                    b.HasOne("TaskManager.Data.Department", "Department")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskManager.Data.SubTask", b =>
                {
                    ...
                    b.HasOne("TaskManager.Data.Employee", "SubTaskAssignee")
                        .WithMany()
                        .HasForeignKey("SubTaskAssigneeId");
            ...
            modelBuilder.Entity("TaskManager.Data.TaskAudit", b =>
                {
                    b.HasOne("TaskManager.Data.Employee", "ActionBy")
                        .WithMany()
                    ...
                    b.HasOne("TaskManager.Data.AuditType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskManager.Data.TaskFollowUp", b =>
                {
                    b.HasOne("TaskManager.Data.Employee", "Follower")
                        .WithMany()
                        .HasForeignKey("FollowerId");

                    b.HasOne("TaskManager.Data.TaskFollowUpStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskManager.Data.TaskFollowUpResponse", b =>
                {
                    b.HasOne("TaskManager.Data.Employee", "RespondedBy")
                        .WithMany()
